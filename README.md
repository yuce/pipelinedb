...
```
sudo apt-get install libreadline6 libreadline6-dev check g++ flex bison python-pip pkgconf zlib1g-dev python-dev libpq-dev libncurses-dev libcurl4-openssl-dev expect libzmq3-dev
